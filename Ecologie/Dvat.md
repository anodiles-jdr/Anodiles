...
- deux pattes antérieures, terminées par de puissantes griffes
- un abdomen allongé
- une double queue, rigide et pointue
- une paire d’ailes membraneuses, capables de portance prolongée
...
Lorsqu’il attaque, le dvat utilise une tactique simple et brutale :

- saisie de la proie par les griffes
- immobilisation
- perforation répétée à l’aide des queues

Le dvat est un animal extrêmement endurant. Il sait nager, voler et courir sur de longues distances.  
Des observations maritimes attestent de dvats attaquant :

- dauphins
- requins
- et même des baleines

Il convient de rappeler aux voyageurs imprudents que :
...
- redoutable lors des abordages

Le cri du dvat — un croassement grave rappelant celui d’un corbeau géant — provoque un effet de sidération psychologique chez de nombreux adversaires.
...
La perte de contrôle sur une telle monture est considérée comme un crime militaire majeur.

Des siècles de sélection ont permis d’atteindre les performances actuelles :

- transport d’un cavalier sur près de 300 kilomètres
