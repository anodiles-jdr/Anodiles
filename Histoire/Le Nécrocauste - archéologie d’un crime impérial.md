...
> « Chaque nécrocauste est l’occasion de produire un **bataillon** pour une des familles majeures. […]  
> Troupes lourdes : silhouettes massives capables de supporter pieux et plaques.  
> Troupes rapides : femmes prioritairement ; faute de mieux, garçons de 13–16 printemps, mais la matière jeune s’altère trop vite.  
> Gabarits hors norme : géants pour le choc (zombies lourds), nabots pour le commando (squelettes).  
> Chefs : _âmes fortes_, détectées par torture de masse, jeux de souffrance, ou **pseudo‑rébellion**. » — _Témoignage d’un trieur_

Ce tri est suivi d’une **fabrication** : goules, nécrophages, mutants zombies (rares, instables), tandis que les “inutiles” alimentent les **sacrifices** ou les **démonistes**. L’ingénierie est complétée par des **politiques démographiques** (primes de naissance, concours artisanaux offrant immunités familiales) et une **pédagogie contrainte** (“première levée” à la boule de 15 kg, outils et ration pour fidéliser).
...
1. **La faim** : raréfaction organisée, taxation, ruptures d’approvisionnement, pour rendre les populations **négociables**. _Échos : famines administrées ou aggravées par les politiques publiques_ (_Holodomor_, _Bengale 1943_).
    
2. **L’archive** : chroniques impériales, “preuves” écrites par des immortels au service du pouvoir, contre une **mémoire orale** affamée et dispersée.
...
> « Le Maître trieur lit les noms… On m’appelle. _La boule des jeunes hommes._ Je la soulève — un instant.  
> _Caserne dès ce soir._  
> Puis un autre nom, une autre sentence : _brigade sanitaire… leur sang est mauvais_. » — _Parcelle 22 (enfant), promotions_
...
- **bataillons livrés** aux familles (prestige, contrôle territorial),
- **matières rituelles** pour démonistes (pierres vertes, sang, “stock” humain),
- **travail forcé** pour les chantiers (ports, comptoirs, routes),
- **marchés noirs** qui prospèrent (contrebandes, _acier de liberté_),
...
- l’Empire maintient la version **nécroCOSTe** (ordre, hygiène, prospérité, “prélèvements” rationnels),
- les résistants et l’historiographie indépendante imposent **nécrocauste** (extermination, colonisation, profits rituels),
...
> « Longtemps, nous avons été des brebis données aux loups.  
...
- **Matériaux de mise en scène** : extraits de journaux clandestins, listes d’affectation, cartes de “parcelles”, billets de propagande.
- **Cadre éthique** : éviter la complaisance visuelle ; privilégier l’analyse, les choix moraux et les conséquences.