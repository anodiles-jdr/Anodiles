...
|---|---|---|
|💰 Argent|+4|Richesse discrète mais immense|
|✨ Magie|+2|Artefacts élémentaires|
|🌾 Nourriture|+2|Îles contrôlées|
|🧑‍🤝‍🧑 Population|+2|Équipages stables|
|⚔️ Armée / Force|+3|Pirates lourds|
|📚 Savoir|+1|Commerce et tactiques|
|🕵️ Réseau / Espions|+1|Renseignement impérial|
|⭐ Elite|+2|Gardes et capitaines|
|🤝 Diplomatie Clan|+1|Intéressée, distante|
|🌐 Diplomatie Empires|+4|Bras officieux de la Monarchie|

---

## 🧩 Aspects secondaires

### 🦀 À la botte de la Monarchie

_L’or impérial parle fort._  
_La loyauté se paie._

- ✅ Invocation : soutien impérial, immunité politique
- ❌ Contrainte : suspicion, hostilité des clans neutres

---

### ⚓ Lourds, patients, mortels

_Le Homard ne poursuit pas._  
_Il encercle._

- ✅ Invocation : prises en tenaille, combat rapproché
- ❌ Contrainte : lenteur, difficulté à se replier

---

### 🌊 On est fort chez nous

_Îles fortifiées._  
_Sous‑marins._  
_Scaphandres._

- ✅ Invocation : supériorité défensive, combat sous‑marin
- ❌ Contrainte : dépendance au terrain, prévisibilité
...
- Pirates devenus commerçants exclusifs
- Culture du secret et de la retenue
- Richesse ostentatoire mal vue
- Armures lourdes adaptées au combat maritime

---

## 📜 Secrets (MJ)

- Plusieurs capitaines sont des agents impériaux déclarés.
- L’île sous‑marine abrite un centre de renseignement monarchique.
- Certains diplomates lieurs manipulent subtilement les négociations inter‑clans.